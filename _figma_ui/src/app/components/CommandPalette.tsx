...
const commands = [
  ...
  { id: 'add-lead', icon: Building2, label: 'Add lead', category: 'Actions', action: 'addPerson' },
  ...
  { id: 'change-status', icon: RefreshCw, label: 'Change lead status', category: 'Actions', path: '/accounts' },
  ...
  { id: 'leads', icon: Building2, label: 'Go to Leads', category: 'Navigate', path: '/accounts' },
