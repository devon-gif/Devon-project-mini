...
export const accounts: Account[] = [
  {
    ...
    notes: 'Series D, expanding APAC team', logo: '', tags: ['Hot', 'Enterprise'],
    peopleCount: 4, signalScore: 92,
  },
  {
    id: '2', company: 'Notion', domain: 'notion.so', tier: 'P0', industry: 'Productivity',
    status: 'Prospecting', lastTouch: '1 day ago', nextStep: 'Send intro email', owner: 'You',
    notes: 'Hiring 20 engineers this quarter', logo: '', tags: ['Hiring Signal'],
    peopleCount: 3, signalScore: 87,
  },
  {
    id: '3', company: 'Figma', domain: 'figma.com', tier: 'P0', industry: 'Design Tools',
    status: 'Nurturing', lastTouch: '3 days ago', nextStep: 'Share case study', owner: 'You',
    notes: 'Met at SaaStr conference', logo: '', tags: ['Conference Lead'],
    peopleCount: 2, signalScore: 78,
  },
  {
    id: '4', company: 'Linear', domain: 'linear.app', tier: 'P1', industry: 'Dev Tools',
    status: 'Prospecting', lastTouch: '5 days ago', nextStep: 'Research buying committee', owner: 'You',
    notes: 'Series B, rapid growth', logo: '', tags: ['Funded'],
    peopleCount: 2, signalScore: 74,
  },
  {
    id: '5', company: 'Vercel', domain: 'vercel.com', tier: 'P1', industry: 'Infrastructure',
    status: 'Active', lastTouch: '1 day ago', nextStep: 'Schedule call with VP Eng', owner: 'You',
    notes: 'Interested in enterprise plan', logo: '', tags: ['Enterprise', 'Hot'],
    peopleCount: 3, signalScore: 85,
  },
  {
    id: '6', company: 'Databricks', domain: 'databricks.com', tier: 'P0', industry: 'Data/AI',
    status: 'Active', lastTouch: '6 hours ago', nextStep: 'Send proposal', owner: 'You',
    notes: 'Budget approved Q1', logo: '', tags: ['Hot', 'Budget Ready'],
    peopleCount: 5, signalScore: 95,
  },
  {
    id: '7', company: 'Airtable', domain: 'airtable.com', tier: 'P1', industry: 'Productivity',
    status: 'Nurturing', lastTouch: '1 week ago', nextStep: 'Re-engage champion', owner: 'You',
    notes: 'Champion changed roles', logo: '', tags: ['At Risk'],
    peopleCount: 2, signalScore: 45,
  },
  {
    id: '8', company: 'Plaid', domain: 'plaid.com', tier: 'P1', industry: 'Fintech',
    status: 'Prospecting', lastTouch: '4 days ago', nextStep: 'Connect via mutual', owner: 'You',
    notes: 'Warm intro available via Sarah K.', logo: '', tags: ['Warm Intro'],
    peopleCount: 2, signalScore: 68,
  },
  {
    ...
    notes: 'Fast-growing creator monetization platform, building out People team', logo: '', tags: ['Hiring Signal'],
    peopleCount: 1, signalScore: 72,
  },
  {
    id: '10', company: 'SecurityScorecard', domain: 'securityscorecard.com', tier: 'P1', industry: 'Cybersecurity',
    status: 'Prospecting', lastTouch: '3 days ago', nextStep: 'Send cold outreach to TA Manager', owner: 'You',
    notes: 'Enterprise cybersecurity ratings platform, scaling GTM team', logo: '', tags: ['Enterprise'],
    peopleCount: 1, signalScore: 65,
  },
  {
    id: '11', company: 'Vimeo', domain: 'vimeo.com', tier: 'P0', industry: 'Video Technology',
    status: 'Prospecting', lastTouch: '1 day ago', nextStep: 'Research org chart, reach talent exec', owner: 'You',
    notes: 'Public company, restructuring talent org post-spin-off', logo: '', tags: ['Enterprise', 'Hiring Signal'],
    peopleCount: 1, signalScore: 80,
  },
  {
    id: '12', company: 'Chipotle Mexican Grill', domain: 'chipotle.com', tier: 'P0', industry: 'Restaurant / QSR',
    status: 'Prospecting', lastTouch: '5 days ago', nextStep: 'Connect with Director of TA', owner: 'You',
    notes: 'Massive hiring volume, 100K+ employees, exploring tech-enabled recruiting', logo: '', tags: ['Enterprise', 'High Volume'],
    peopleCount: 1, signalScore: 77,
  },
  {
    ...
    notes: 'Global leadership training company, steady hiring for consultants', logo: '', tags: ['Warm Intro'],
    peopleCount: 1, signalScore: 55,
  },
  {
    id: '14', company: 'Amplify', domain: 'amplify.com', tier: 'P1', industry: 'Education Technology',
    status: 'Prospecting', lastTouch: '4 days ago', nextStep: 'Send intro email to TA Director', owner: 'You',
    notes: 'K-12 edtech, backed by Emerson Collective, expanding product & eng', logo: '', tags: ['Funded', 'Hiring Signal'],
    peopleCount: 1, signalScore: 70,
  },
  {
    id: '15', company: 'Zapier', domain: 'zapier.com', tier: 'P0', industry: 'Automation / SaaS',
    status: 'Prospecting', lastTouch: '2 days ago', nextStep: 'Draft personalized outreach to Global Head of Talent', owner: 'You',
    notes: 'Fully remote, 800+ employees, known for strong remote culture', logo: '', tags: ['Remote-First', 'Hot'],
    peopleCount: 1, signalScore: 88,
  },
  {
  ...
  },
  {
    ...
    notes: 'HR advisory firm, potential channel partner for Twill referrals', logo: '', tags: ['Partner Lead'],
    peopleCount: 1, signalScore: 50,
  },
  {
    id: '18', company: 'Stuf Storage', domain: 'stufstorage.com', tier: 'P2', industry: 'Storage / Real Estate',
    status: 'Prospecting', lastTouch: '6 days ago', nextStep: 'Send intro email to Chief of Staff', owner: 'You',
    notes: 'Fast-growing storage startup, lean team, Chief of Staff runs People', logo: '', tags: ['Startup'],
    peopleCount: 1, signalScore: 48,
  },
  {
    id: '19', company: 'Crunchyroll', domain: 'crunchyroll.com', tier: 'P0', industry: 'Entertainment / Streaming',
    status: 'Prospecting', lastTouch: '2 days ago', nextStep: 'Outreach to Head of TA / VP Global Talent', owner: 'You',
    notes: 'Sony-owned anime streaming, ramping eng & content ops hiring globally', logo: '', tags: ['Enterprise', 'Hiring Signal'],
    peopleCount: 1, signalScore: 82,
  },
  {
    id: '20', company: 'Vitalize', domain: 'vitalize.vc', tier: 'P1', industry: 'Venture Capital',
    status: 'Prospecting', lastTouch: '4 days ago', nextStep: 'Intro to founders — explore portfolio deal', owner: 'You',
    notes: 'YC-backed VC firm, can unlock portfolio companies as Twill customers', logo: '', tags: ['VC / Channel', 'Warm Intro'],
    peopleCount: 2, signalScore: 75,
  },
];
...
export const people: Person[] = [
  ...
  {
    id: '9', name: 'Alexa Ishibashi', title: 'People Operations Lead, Talent & Culture', company: 'Stan', accountId: '9',
  ...
  },
  {
    ...
    linkedin: 'linkedin.com/in/taha-usmani-b27052211',
    lastEmail: 'Never', replyStatus: 'No reply', nextTask: 'Send cold outreach',
  ...
  },
  {
    ...
    lastEmail: 'Never', replyStatus: 'No reply', nextTask: 'Draft outreach emphasizing high-volume hiring',
  ...
  {
    id: '16', name: 'Lyndsey French', title: 'Global Talent Acquisition Leader', company: '1Password', accountId: '16',
  ...
  },
  {
    ...
    linkedin: 'linkedin.com/in/michelle-morand-05983091',
    lastEmail: 'Never', replyStatus: 'No reply', nextTask: 'Send intro email',
  ...
  {
    id: '19', name: 'Ray Schneider', title: 'Head of Talent Acquisition / VP Global Talent', company: 'Crunchyroll', accountId: '19',
    seniority: 'VP', email: 'ray.schneider@crunchyroll.com', emailStatus: 'unverified',
    linkedin: 'linkedin.com/in/raymondschneider',
    lastEmail: 'Never', replyStatus: 'No reply', nextTask: 'Draft outreach referencing anime/entertainment hiring',
  ...
  },
  {
    ...
    linkedin: 'linkedin.com/in/veeraj-shah-125563125',
...
export const sequences: Sequence[] = [
  {
    id: '1', name: 'VP Engineering — Cold Outreach', status: 'active',
    enrolled: 45, replied: 12, openRate: 68, replyRate: 27,
    steps: [
      { id: 's1', order: 1, type: 'email', subject: 'Quick question about {company} hiring', delay: 0, body: 'Hi {first_name},...' },
      { id: 's2', order: 2, type: 'linkedin', delay: 2, body: 'Connect request + note' },
      { id: 's2b', order: 3, type: 'video', subject: 'Personalized video for {first_name}', delay: 1, body: 'Website scroll + webcam — highlight Careers page' },
      { id: 's3', order: 4, type: 'email', subject: 'Re: {company} engineering growth', delay: 3, body: 'Following up...' },
      { id: 's4', order: 5, type: 'call', delay: 2, body: 'Discovery call attempt' },
      { id: 's5', order: 6, type: 'email', subject: 'Last touch — {company}', delay: 4, body: 'Final email...' },
    ],
  },
  {
    id: '2', name: 'Head of Talent — Warm Intro', status: 'active',
    enrolled: 22, replied: 9, openRate: 82, replyRate: 41,
    steps: [
      { id: 's6', order: 1, type: 'email', subject: '{mutual} suggested I reach out', delay: 0, body: 'Hi {first_name},...' },
      { id: 's7', order: 2, type: 'email', subject: 'Re: Twill for {company}', delay: 3, body: 'Bump email...' },
      { id: 's8', order: 3, type: 'linkedin', delay: 2, body: 'LinkedIn message' },
  ...
  },
  {
    ...
    steps: [
      ...
      { id: 's11', order: 2, type: 'email', subject: 'Case study: How {similar_company} hired 50 engineers', delay: 5, body: 'Thought you\'d find this relevant...' },
